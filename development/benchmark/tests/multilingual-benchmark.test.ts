...
import { WnTsLibrary } from '../lib/wordnet-libraries/wn-ts.ts';
import { WnPybridgeLibrary } from '../lib/wordnet-libraries/wn-pybridge.ts';
import { MultilingualWordNetLibraryBase } from '../lib/WordNetLibraryBase.ts';
