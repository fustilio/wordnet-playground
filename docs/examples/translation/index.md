...
description: Cross-lingual translation workflows and examples
---
...
This guide showcases how to implement cross-lingual translation workflows using the ILI (Interlingual Index) system and the translation plugin.
...
### **2. Translation with Confidence Scoring**
...
**Ready to build your own translation system? Check out the [Plugin Development](/api/plugins/) guide!**