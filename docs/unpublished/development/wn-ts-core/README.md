...
- **[Architecture Guide](../../../architecture/)** - Complete system architecture
- **[Development Conventions](../../../standards/development-conventions.md)** - Coding standards and patterns
- **[Database Schema Standards](../../../standards/database-schema-standards.md)** - Database design and optimization
