...
export class SchemaBuilder {
  ...
  static async createTables(db: Kysely<Database>): Promise<void> {
    ...
    await this.createLexiconsTable(schema);
    await this.createWordsTable(schema);
    await this.createFormsTable(schema);
    await this.createSynsetsTable(schema);
    await this.createSensesTable(schema);
    await this.createDefinitionsTable(schema);
    await this.createRelationsTable(schema);
    await this.createExamplesTable(schema);
    await this.createIlisTable(schema);
  }
