/**
 * User-friendly error classes for WordNet TypeScript Web
 */
  ...
  constructor(message: string, cause?: Error) {
    super(
      ...
      [
        ...
        'Try using a different storage type (opfs, indexeddb, memory)'
      ],
      cause
    );
  ...
  constructor(message: string, cause?: Error) {
    super(
      ...
      [
        ...
        'Check browser compatibility for your chosen storage type'
      ],
      cause
    );
  ...
  constructor(message: string, cause?: Error) {
    super(
      ...
      [
        ...
        'Check if your browser blocks the download'
      ],
      cause
    );
