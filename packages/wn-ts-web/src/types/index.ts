...
export interface SenseInfo
	extends Pick<
		Sense,
		"id" | "wordId" | "synsetId" | "source" | "sensekey" | "adjposition"
	> {
	subcategory?: string;
	domain?: string;
	register?: string;
...
export interface DefinitionInfo
	extends Pick<Definition, "id" | "language" | "text" | "source"> {
	synsetId: string; // Add synsetId for UI convenience
}

export interface ExampleInfo
	extends Pick<Example, "id" | "language" | "text" | "source"> {
	synsetId: string; // Add synsetId for UI convenience
}
...
export interface PackageInfo
	extends Pick<
		Project,
		"id" | "label" | "description" | "url" | "license" | "citation"
	> {
	language?: string;
	versions: string[];
}
...
export type WordNetEventListener<K extends keyof WordNetEventMap> = (
	event: WordNetEventMap[K]
) => void;
