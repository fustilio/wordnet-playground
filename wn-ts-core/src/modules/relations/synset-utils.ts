 ...
 */
export async function hypernyms(synset: Synset, wordnet: WordNetCore): Promise<Synset[]> {
 ...
 */
async function allHypernymPaths(synset: Synset, wordnet: WordNetCore): Promise<Synset[][]> {
  const paths: Synset[][] = [];
